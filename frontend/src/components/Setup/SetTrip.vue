...
<script>
  ...
  export default{
    ...
    computed: {
      ...
      location: {
        get() {
          return this.$store.state.trip.location
        },
        set(newLocation) {
...
.multiselect.is-disabled{
  cursor:default;background:var(--ms-bg-disabled,#2f446e)
}

.multiselect.is-active{
  box-shadow:0 0 0 var(--ms-ring-width,3px) var(--ms-ring-color,rgba(255, 255, 255, 0.188))
}
...
.multiselect-placeholder{
  color:var(--ms-placeholder-color,#101072)
}
